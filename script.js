...
function t4(event) {
    ...
    event = document.querySelector(".i-4").value;
    document.querySelector(".out-4").innerHTML = event.toLowerCase();
}
...
function t5(event) {
    console.log(event);
    event = document.querySelector(".i-5").value;
    document.querySelector(".out-5").innerHTML = event.toUpperCase();
}
...
function t7(event) {
    if(event.key) {
        ...
        let rValue = a7[rand];
        document.querySelector(".out-7").innerHTML = rValue;
    }
}
...
function t8(event) {
    ...
    document.querySelector(".out-8").innerHTML = inp8;
}
...
document.querySelector(".i-9").addEventListener("keydown", function(e) {
    if(e.keyCode == 40) {
        counter = counter + 1;
    }
    document.querySelector(".out-9").innerHTML = e.key + ": " + counter;
});
...
let h = 75;
let w = 75;
let div10 = document.querySelector(".block-10");
...
function t11(event) {
    let w = event.code.toLowerCase();

    let inp11 = document.querySelector(".i-11").value;
        div11.forEach((data) => {
            data.classList.remove("active");
            inp11 = data.getAttribute("data");
            if(inp11 == event.key || inp11 == w) {
